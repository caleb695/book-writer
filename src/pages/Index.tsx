  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <div className={activeTab === "style" ? "flex-1 flex flex-col" : "hidden"}>
        <StyleTab files={files} onUpload={handleUploadFile} onDelete={deleteFile} styleMemory={styleMemory} stylePatterns={stylePatterns} onSaveSynthesis={saveSynthesis} onUpdateCustomPrompt={updateCustomPrompt} aiSettings={aiSettings} />
      </div>
